  ...
  <h1 class="text-center my-2 py-2">View All Trip</h1>
  <div class="container">
        <div class="row">
            <div class="col-8 mx-auto">

                <?php if(isset($warning)): ?>
                    <h3 class="alert alert-danger text-center"><?php echo $warning; ?></h3>
                <?php endif; ?>


                <form class="p-5 border mb-5" method="POST" action="<?php url('booking/search_trip');?>">
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" required class="form-control" name="date_depart" id="date_depart">
                    </div>
